        ...
        <div class="div-block-11-copy-copy-copy">
          ...
          <div class="div-block-10">
            ...
            <div class="w-layout-blockcontainer container-8 w-container">
              ...
              <div class="div-block-6">
                <h6 class="heading-6">訂單編號</h6>
                <div id="w-node-_9918e391-f400-77f8-6d15-7de42ad3aed8-38526047">5team8f458fa87c</div>
                <div id="w-node-_4415dbb6-3a6c-1e7b-0f70-3965e20b112b-38526047">5team677934c2b3</div>
                <div id="w-node-b06d2de8-5238-ef30-349a-0f3fbb4c3b1a-38526047">5teamffb767f24a</div>
              </div>
                <div class="div-block-7">
                <h6 class="heading-7">商品名稱</h6>
                <div id="w-node-_7d094d73-3116-19db-8316-66b1a1d46001-38526047">CSGO</div>
                <div id="w-node-fe29563a-1fa4-6dd4-edd1-e93357cfebf0-38526047">收穫日III</div>
                <div id="w-node-_21eb060b-e59e-9db4-3169-dfff5c68ae30-38526047">天命II</div>
              </div>
              <div class="div-block-8">
                <h6 class="heading-8">總計</h6>
                <div id="w-node-_583a994e-5bac-583d-219b-6e8d0ab57037-38526047">
                  <div class="text-block-30">NT$ 200</div>
                </div>
                <div class="text-block-5">NT$ 500</div>
                <div class="text-block-31">NT$ 300</div>
              </div>
            </div>
          </div>
        </div>
