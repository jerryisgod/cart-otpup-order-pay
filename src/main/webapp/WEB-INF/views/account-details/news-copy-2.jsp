...
<html data-wf-page="650071e17cd3c26438525ff8" data-wf-site="64e5ed3359b16400aec286b0">
<head>
  <meta charset="utf-8">
  <title>News</title>
...
<body>
  ...
  <div class="pag11111888py">
        ...
        <div class="wrapper nav-bar-wrapper">
          ...
          <div class="navigation">
            <nav role="navigation" class="nav-menu w-nav-menu">
              ...
              <a href="account-details/news-copy-2.html" aria-current="page" class="nav-link w-nav-link w--current">消息新聞</a>
    ...
    <div class="text-block-23">
      <a href="index.html" class="link-9">首頁</a>&gt;新聞
    </div>
    <div class="section no-padding-vertical">
      <div class="wrapper side-paddings"></div>
    </div>
    <div class="wrapper"></div>
    <section class="team-slider-c4819py-copy">
      <div class="container-10">
        <div class="w-layout-blockcontainer container-11 w-container"><img src="images/LOGO.png" loading="lazy" width="161" sizes="(max-width: 479px) 100vw, (max-width: 767px) 30vw, 160.98959350585938px" alt="" srcset="images/LOGO-p-500.png 500w, images/LOGO.png 556w" class="image-2">
          <div class="text-block-6">新聞</div>
        </div>
        <div data-delay="4000" data-animation="slide" class="team-slider-wrapper w-slider" data-autoplay="false" data-easing="ease" data-hide-arrows="false" data-disable-swipe="false" data-autoplay-limit="0" data-nav-spacing="12" data-duration="500" data-infinite="true">
          <div class="w-slider-mask">
            <div class="team-slide-wrapper w-slide">
              <div>
                <div class="team-block"><img src="https://uploads-ssl.webflow.com/62434fa732124a0fb112aab4/62434fa732124af1aa12aadf_placeholder%201.svg" loading="lazy" alt="" class="team-member-image-two">
                  <div class="team-block-info">
                    <h3 class="team-member-name-two">Steam潛行節已熱烈開始</h3>
                    <p class="team-member-text">
                      <a href="account-details/news-page.html" class="link-7">Steam 潛行節正熱烈進行中，從現在至 7 月 31 日上午 10 點（PT）止！ 參加活動以享受折扣、試玩版，以及更多各式潛行遊戲的精彩內容。</a>
                    </p>
      ...
      <div class="container">
        <div class="footer-wrapper-two">
          ...
          <div class="footer-form w-form">
            <form id="wf-form-Footer-Form" name="wf-form-Footer-Form" data-name="Footer Form" method="get" class="footer-form-container" data-wf-page-id="650071e17cd3c26438525ff8" data-wf-element-id="2f28f37e-4498-a339-8d3d-a046cad60e2b">
