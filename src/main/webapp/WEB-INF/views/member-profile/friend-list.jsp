          ...
          <nav role="navigation" class="nav-menu w-nav-menu">
            ...
            <div data-hover="false" data-delay="0" class="dropdown w-dropdown">
              ...
              <nav class="w-dropdown-list">
                ...
                <a href="member-profile/friend-list.html" aria-current="page" class="dropdown-link-2 w-dropdown-link w--current">好友</a>
      ...
      <div class="f-career-wrapper">
        <div data-duration-in="300" data-duration-out="100" data-current="Tab 4" data-easing="ease" class="f-tab-copy w-tabs">
          <div class="f-tab-menu w-tab-menu">
            <a data-w-tab="Tab 4" class="f-tab-button w-inline-block w-tab-link w--current">
              ...
              <div class="f-modal-base-small myfriend">
                <div class="f-modal-form-block w-form">
                  <form id="email-form" name="email-form" data-name="Email Form" method="get" class="form-5" data-wf-page-id="650071e17cd3c26438525fb8" data-wf-element-id="523fe998-b8ce-1f55-bbb6-5c1ece1be436">
                    <div class="f-sub-heading-regular">您的好友目錄</div>
                    <div class="f-modal-search">
                      <div class="f-field-label-6">搜尋</div>
                      <div class="f-field-icon-wrapper-2"><input type="text" class="f-field-input-icon w-input" maxlength="256" name="Modal-Field-Search-2" data-name="Modal Field Search 2" placeholder="輸入好友名稱" id="Modal-Field-Search-2">
