...
<html data-wf-page="650071e17cd3c26438525fdc" data-wf-site="64e5ed3359b16400aec286b0">
<head>
  <meta charset="utf-8">
  <title>member profile</title>
  <meta content="member profile" property="og:title">
  <meta content="member profile" property="twitter:title">
...
<body class="body-9">
        ...
        <div class="navigation">
          <nav role="navigation" class="nav-menu w-nav-menu">
            ...
            <div data-hover="false" data-delay="0" class="dropdown w-dropdown">
              ...
              <nav class="w-dropdown-list">
                <a href="member-profile/member-profile.html" aria-current="page" class="dropdown-link w-dropdown-link w--current">個人資料</a>
  ...
  <div class="f-section-large-4">
    <div class="text-block-25">
      <a href="index.html" class="link-10">首頁</a>&gt;會員中心&gt;個人資料
    </div>
    <div class="f-container-regular-2">
      <div class="f-career-wrapper">
        <div data-duration-in="300" data-duration-out="100" data-current="Tab 1" data-easing="ease" class="f-tab-copy w-tabs">
          <div class="f-tab-menu w-tab-menu">
            <a data-w-tab="Tab 1" class="f-tab-button w-inline-block w-tab-link w--current">
              <div class="text-block-10">個人資料</div>
            </a>
          </div>
          <div class="w-tab-content">
            <div data-w-tab="Tab 1" class="f-tab-pane-2-copy w-tab-pane w--tab-active">
              <div class="f-margin-bottom-71"><img width="300" sizes="(max-width: 479px) 53vw, 300px" src="images/螢幕擷取畫面_2023-09-02__1_-removebg-preview.png" loading="lazy" alt="" srcset="images/螢幕擷取畫面_2023-09-02__1_-removebg-preview-p-500.png 500w, images/螢幕擷取畫面_2023-09-02__1_-removebg-preview.png 552w" class="image-46">
                <div class="f-career-title-centre">
                  <div class="f-margin-bottom-12">
                    <div class="f-heading-detail-small-4">XXX 您好</div>
                  </div>
                  <div class="f-margin-bottom-12">
                    <h3 class="f-h3-heading-6">個人資料</h3>
                  </div>
                </div>
              </div>
              <div class="w-layout-grid f-career-table">
                <div id="w-node-c764d726-9e84-740d-1833-c6421cce6708-38525fdc" class="f-career-row-wrapper">
                  <div class="w-layout-grid f-career-row">
                    <div>
                      <div class="f-paragraph-regular-4"><img sizes="(max-width: 479px) 42vw, (max-width: 767px) 33vw, 556.0069580078125px" srcset="images/LOGO-p-500.png 500w, images/LOGO.png 556w" src="images/LOGO.png" loading="lazy" alt="" class="image-47"></div>
                    </div>
                    <div id="w-node-c764d726-9e84-740d-1833-c6421cce670d-38525fdc">
                      <div class="f-paragraph-regular-4 f-text-color-gray-500 tet">個人資訊</div>
                    </div>
                    <div id="w-node-c764d726-9e84-740d-1833-c6421cce6710-38525fdc" class="div-block-19">
                      <a href="#" class="f-careers-text-link test123">修改資料</a>
                    </div>
                  </div>
                </div>
                <div id="w-node-f60e9ffe-7ad0-eb00-6a8c-081bff0d6a19-38525fdc" class="f-career-row-wrapper">
                  <div class="w-layout-grid f-career-row">
                    <div>
                      <div class="f-paragraph-regular-4">會員名稱</div>
                    </div>
                    <div id="w-node-f60e9ffe-7ad0-eb00-6a8c-081bff0d6a1e-38525fdc">
                      <div class="f-paragraph-regular-4 f-text-color-gray-500">test123</div>
                    </div>
                    <div id="w-node-f60e9ffe-7ad0-eb00-6a8c-081bff0d6a21-38525fdc">
                      <a href="#" class="f-careers-text-link">更改</a>
                    </div>
                  </div>
                </div>
                <div id="w-node-c764d726-9e84-740d-1833-c6421cce6713-38525fdc" class="f-career-row-wrapper">
                  <div class="w-layout-grid f-career-row">
                    <div>
                      <div class="f-paragraph-regular-4">會員帳號</div>
                    </div>
                    <div id="w-node-c764d726-9e84-740d-1833-c6421cce6718-38525fdc">
                      <div class="f-paragraph-regular-4 f-text-color-gray-500">abcde</div>
                    </div>
                    <div id="w-node-c764d726-9e84-740d-1833-c6421cce671b-38525fdc">
                      <a href="#" class="f-careers-text-link">更改</a>
                    </div>
                  </div>
                </div>
                <div id="w-node-c764d726-9e84-740d-1833-c6421cce671e-38525fdc" class="f-career-row-wrapper">
                  <div class="w-layout-grid f-career-row">
                    <div>
                      <div class="f-paragraph-regular-4">會員密碼</div>
                    </div>
                    <div id="w-node-c764d726-9e84-740d-1833-c6421cce6723-38525fdc">
                      <div class="f-paragraph-regular-4 f-text-color-gray-500">112233</div>
                    </div>
                    <div id="w-node-c764d726-9e84-740d-1833-c6421cce6726-38525fdc">
                      <a href="#" class="f-careers-text-link">更改</a>
                    </div>
                  </div>
                </div>
                <div id="w-node-c764d726-9e84-740d-1833-c6421cce6729-38525fdc" class="f-career-row-wrapper">
                  <div class="w-layout-grid f-career-row">
                    <div>
                      <div class="f-paragraph-regular-4">會員信箱</div>
                    </div>
                    <div id="w-node-c764d726-9e84-740d-1833-c6421cce672e-38525fdc">
                      <div class="f-paragraph-regular-4 f-text-color-gray-500">XXXX@gmail.com</div>
                    </div>
                    <div id="w-node-c764d726-9e84-740d-1833-c6421cce6731-38525fdc">
                      <a href="#" class="f-careers-text-link">更改</a>
                    </div>
                  </div>
                </div>
      ...
      <div class="container">
        <div class="footer-wrapper-two">
          ...
          <div class="footer-form w-form">
            <form id="wf-form-Footer-Form" name="wf-form-Footer-Form" data-name="Footer Form" method="get" class="footer-form-container" data-wf-page-id="650071e17cd3c26438525fdc" data-wf-element-id="da20ee2c-0777-11ec-006c-95599e3f13b5">
