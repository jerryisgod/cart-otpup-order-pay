...
<html data-wf-page="650071e17cd3c26438525fba" data-wf-site="64e5ed3359b16400aec286b0">
<head>
  <meta charset="utf-8">
  <title>friend list Copy</title>
  <meta content="friend list Copy" property="og:title">
  <meta content="friend list Copy" property="twitter:title">
  ...
  <div class="f-section-large-4">
    ...
    <div class="f-container-regular-2">
      <div class="f-career-wrapper">
        <div data-duration-in="300" data-duration-out="100" data-current="Tab 3" data-easing="ease" class="f-tab-copy w-tabs">
          <div class="f-tab-menu w-tab-menu">
            <a data-w-tab="Tab 3" class="f-tab-button w-inline-block w-tab-link w--current">
              <div class="text-block-12"><span>新增好友</span></div>
            </a>
          </div>
          <div class="w-tab-content">
            <div data-w-tab="Tab 3" class="f-tab-pane-2 w-tab-pane w--tab-active">
              <div class="f-modal-base-small">
                <div class="f-modal-form-block w-form">
                  <form id="email-form" name="email-form" data-name="Email Form" method="get" class="form-5" data-wf-page-id="650071e17cd3c26438525fba" data-wf-element-id="554e4d57-1492-c1b5-0ef9-9b91456ba654">
                    <div class="f-modal-search">
                      <p class="f-paragraph-small-2">輸入對方ID，邀請他們成為好友</p>
                      <div class="f-field-label-6">搜尋</div>
                      <div class="f-field-icon-wrapper-2"><input type="text" class="f-field-input-icon w-input" maxlength="256" name="Modal-Field-Search" data-name="Modal Field Search" placeholder="輸入好友名稱" id="Modal-Field-Search">
                    ...
                    <div class="f-modal-user-list">
                      <div class="w-layout-grid f-modal-user-grid">
                        <div class="f-modal-invite">
                          <div class="f-modal-avatar"><img alt="" loading="lazy" src="images/Avatar-03.png" class="f-avatar-image"></div>
                          <div>
                            <div class="f-paragraph-regular-7 f-text-weight-medium">Customer Name</div>
                            <div class="f-paragraph-small-2">hello@website.com</div>
                          </div>
                        </div>
                        <div class="f-modal-invite">
                          <div class="f-modal-avatar"><img alt="" loading="lazy" src="images/Avatar-02.png" class="f-avatar-image"></div>
                          <div>
                            <div class="f-paragraph-regular-7 f-text-weight-medium">Customer Name</div>
                            <div class="f-paragraph-small-2">hello@website.com</div>
                          </div>
                        ...
                        <div class="f-modal-invite">
                          <div class="f-modal-avatar"><img alt="" loading="lazy" src="images/Avatar-01.png" class="f-avatar-image"></div>
                          <div>
                            <div class="f-paragraph-regular-7 f-text-weight-medium">Customer Name</div>
                            <div class="f-paragraph-small-2">hello@website.com</div>
                          </div>
                        ...
                        <div class="f-modal-invite">
                          <div class="f-modal-avatar"><img alt="" loading="lazy" src="images/Avatar-04.png" class="f-avatar-image"></div>
                          <div>
                            <div class="f-paragraph-regular-7 f-text-weight-medium">Customer Name</div>
                            <div class="f-paragraph-small-2">hello@website.com</div>
                          </div>
                        ...
                        <div class="f-modal-invite">
                          <div class="f-modal-avatar"><img alt="" loading="lazy" src="images/Avatar-05.png" class="f-avatar-image"></div>
                          <div>
                            <div class="f-paragraph-regular-7 f-text-weight-medium">Customer Name</div>
                            <div class="f-paragraph-small-2">hello@website.com</div>
                          </div>
                        </div>
                        <div id="w-node-_554e4d57-1492-c1b5-0ef9-9b91456ba685-38525fba" class="f-modal-invite">
                          <div class="f-modal-avatar"><img alt="" loading="lazy" src="images/Avatar-02.png" class="f-avatar-image"></div>
                          <div>
                            <div class="f-paragraph-regular-7 f-text-weight-medium">Customer Name</div>
                            <div class="f-paragraph-small-2">hello@website.com</div>
                ...
                <a href="#" class="f-button-primary w-button">好友邀請</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="footer-wrapper-two">
          ...
          <div class="footer-form w-form">
            <form id="wf-form-Footer-Form" name="wf-form-Footer-Form" data-name="Footer Form" method="get" class="footer-form-container" data-wf-page-id="650071e17cd3c26438525fba" data-wf-element-id="da20ee2c-0777-11ec-006c-95599e3f13b5">
