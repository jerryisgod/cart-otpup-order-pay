...
<html data-wf-page="650071e17cd3c26438525fbb" data-wf-site="64e5ed3359b16400aec286b0">
<head>
  <meta charset="utf-8">
  <title>game library</title>
  <meta content="game library" property="og:title">
  <meta content="game library" property="twitter:title">
...
<body class="body-7">
          ...
          <nav role="navigation" class="nav-menu w-nav-menu">
            ...
            <div data-hover="false" data-delay="0" class="dropdown w-dropdown">
              ...
              <nav class="w-dropdown-list">
                ...
                <a href="member-profile/game-library.html" aria-current="page" class="dropdown-link-3 w-dropdown-link w--current">遊戲庫</a>
  ...
  <div class="f-section-large-4">
    ...
    <div class="f-container-regular-2">
      <div class="f-career-wrapper">
        <div data-duration-in="300" data-duration-out="100" data-current="Tab 2" data-easing="ease" class="f-tab-copy w-tabs">
          <div class="f-tab-menu w-tab-menu">
            <a data-w-tab="Tab 2" class="f-tab-button w-inline-block w-tab-link w--current">
              <div class="text-block-11">遊戲庫</div>
            </a>
          </div>
          <div class="w-tab-content">
            <div data-w-tab="Tab 2" class="f-tab-pane-2 w-tab-pane w--tab-active">
              <div class="w-form">
                <form id="email-form" name="email-form" data-name="Email Form" method="get" data-wf-page-id="650071e17cd3c26438525fbb" data-wf-element-id="2e03cfcb-863e-5fa6-2805-e2c9f376aff4">
                  <div class="f-section-large-4">
                    <div class="f-tab-heading">xxx的遊戲庫</div>
                    <div class="f-field-wrapper-2">
                      <div class="f-field-label-5">搜尋遊戲</div>
                      <div class="f-field-icon-wrapper"><input type="text" class="f-field-input-double w-input" maxlength="256" name="Input-Field-Double" data-name="Input Field Double" placeholder="請輸入遊戲名稱" id="Input-Field-Double">
                        ...
                        <div class="f-field-icon-r w-embed"><svg width="420" height="420" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="f-container-regular-2">
                      <div class="w-layout-grid f-gallery-three-column">
                        <div id="w-node-_3312d92e-faf2-08be-9a7b-5419081d2405-38525fbb">
                          <div id="w-node-bbee6cab-9e70-d3fa-675b-cde93084cac8-38525fbb" class="text-block-13">
                            <a href="member-profile/game-page.html">魔物獵人</a>
                          </div>
                          <a href="#" class="f-gallery-lightbox w-inline-block w-lightbox">
                            <div class="f-gallery-image-s"><img alt="" loading="lazy" src="images/huntermonster.jpg" class="f-image-cover-3"></div>
                            <script type="application/json" class="w-json">{
  "items": [
    {
      "_id": "64ea0592f889e9794f10584c",
    ...
    {
      "_id": "64ea2925e764544da8c35967",
      "origFileName": "372279499_666297818762228_2423681392416115580_n.jpg",
      "fileName": "372279499_666297818762228_2423681392416115580_n.jpg",
      "fileSize": 104061,
      "height": 1044,
      "url": "images/372279499_666297818762228_2423681392416115580_n.jpg",
      "width": 1568,
      "type": "image"
    },
    {
    ...
    {
      "_id": "64ea0592f889e9794f105874",
      "origFileName": "huntermonster.jpg",
      "fileName": "huntermonster.jpg",
      "fileSize": 460894,
      "height": 596,
      "url": "images/huntermonster_1.jpg",
      "width": 1066,
      "type": "image"
    },
    {
      "_id": "example_img",
      "origFileName": "Placeholder Logo Image.png",
      "fileName": "Placeholder Logo Image.png",
      "fileSize": 13077,
      "height": 736,
      "url": "https://uploads-ssl.webflow.com/636a47177c6e9adb5c9148ec/63c838ba823e4800a840e092_Placeholder%20Logo%20Image.png",
      "width": 904,
      "type": "image"
    }
  ],
  "group": ""
                        ...
                        <a href="#" class="f-gallery-lightbox w-inline-block w-lightbox">
                          <div class="f-gallery-image-s"><img alt="" loading="lazy" src="images/Placeholder-Gallery.svg" class="f-image-cover-3"></div>
                          <script type="application/json" class="w-json">{
  "items": [
    {
      "_id": "example_img",
      ...
      <div class="container">
        <div class="footer-wrapper-two">
          ...
          <div class="footer-form w-form">
            <form id="wf-form-Footer-Form" name="wf-form-Footer-Form" data-name="Footer Form" method="get" class="footer-form-container" data-wf-page-id="650071e17cd3c26438525fbb" data-wf-element-id="da20ee2c-0777-11ec-006c-95599e3f13b5">
