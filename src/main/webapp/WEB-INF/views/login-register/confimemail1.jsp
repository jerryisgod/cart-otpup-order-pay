...
<html data-wf-page="650071e17cd3c26438525f96" data-wf-site="64e5ed3359b16400aec286b0">
<head>
  <meta charset="utf-8">
  <title>Confimemail1</title>
  ...
  <meta content="Confimemail1" property="og:title">
  ...
  <meta content="Confimemail1" property="twitter:title">
...
<body>
  ...
  <div class="page-ra897oopy">
    ...
    <div class="section-co44y no-padding-vertical">
      <div class="wrapper side-paddings"></div>
      <div class="w-layout-blockcontainer container-31y w-container">
        <h1 class="heading-21y">認證碼以發送到電子郵件</h1>
        <div class="text-block-21y"></div>
        <div class="form-block-3 w-form">
          <form id="email-form" name="email-form" data-name="Email Form" method="get" class="form-8" data-wf-page-id="650071e17cd3c26438525f96" data-wf-element-id="cb9c6e52-7614-a2d6-0fe2-4b61a7323af4"><label for="name" class="field-label-11">認證碼</label><input type="text" class="text-field-4 w-input" maxlength="256" name="name" data-name="Name" placeholder="請輸入電子郵件中的六碼數字" id="name"><input type="submit" value="首頁" data-wait="Please wait..." class="submit-button-4 w-button"></form>
    ...
    <div class="container">
      <div class="footer-wrapper-two">
        ...
        <div class="footer-form w-form">
          <form id="wf-form-Footer-Form" name="wf-form-Footer-Form" data-name="Footer Form" method="get" class="footer-form-container" data-wf-page-id="650071e17cd3c26438525f96" data-wf-element-id="f441a17e-0218-ad41-4792-bb1474696d31">
