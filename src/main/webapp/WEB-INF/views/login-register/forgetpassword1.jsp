...
<html data-wf-page="650071e17cd3c26438525fb6" data-wf-site="64e5ed3359b16400aec286b0">
<head>
  <meta charset="utf-8">
  ...
  <meta content="forgetpassword1" property="og:title">
  ...
  <meta content="forgetpassword1" property="twitter:title">
...
<body>
  ...
  <div class="page-wra178py">
    ...
    <div class="section no-padding-vertical">
      ...
      <div class="w-layout-blockcontainer container-3249opy w-container">
        <h1 class="heading-22y-copy">忘記密碼</h1>
        <div class="text-block-22">讓我們協助你重新設定</div>
        <div class="text-block-21y"></div>
        <div class="w-form">
          <form id="email-form" name="email-form" data-name="Email Form" method="get" class="form-2-copy" data-wf-page-id="650071e17cd3c26438525fb6" data-wf-element-id="cb9c6e52-7614-a2d6-0fe2-4b61a7323af4"><label for="name" class="field-label-13">使用者名稱</label><input type="text" class="text-field-4 w-input" maxlength="256" name="name" data-name="Name" placeholder="您的使用者名稱" id="name"><label for="name-2" class="field-label-12">電子郵件</label><input type="text" class="text-field-4 w-input" maxlength="256" name="name-2" data-name="Name 2" placeholder="註冊時的電子郵件" id="name-2"><input type="submit" value="送出" data-wait="Please wait..." class="submit-button-4 w-button"></form>
    ...
    <div class="container">
      <div class="footer-wrapper-two">
        ...
        <div class="footer-form w-form">
          <form id="wf-form-Footer-Form" name="wf-form-Footer-Form" data-name="Footer Form" method="get" class="footer-form-container" data-wf-page-id="650071e17cd3c26438525fb6" data-wf-element-id="f441a17e-0218-ad41-4792-bb1474696d31">
