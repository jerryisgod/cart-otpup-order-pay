...
<html data-wf-page="650071e17cd3c26438525fe0" data-wf-site="64e5ed3359b16400aec286b0">
<head>
  <meta charset="utf-8">
  <title>model2</title>
...
<body>
  ...
  <div class="page-wr18ypy">
        ...
        <div class="wrapper nav-bar-wrapper">
          ...
          <div class="navigation">
            <nav role="navigation" class="nav-menu w-nav-menu">
              ...
              <a href="login-register/model2.html" aria-current="page" class="nav-link w-nav-link w--current">註冊</a>
    ...
    <div class="f-section-large-2-co28py-copy">
      <div class="w-layout-blockcontainer container-29 w-container">
        ...
        <div class="f-container-x-small">
          ...
          <div class="w-form">
            <form id="wf-form-Contact-Form" name="wf-form-Contact-Form" data-name="Contact Form" method="get" class="f-contact-form-2" data-wf-page-id="650071e17cd3c26438525fe0" data-wf-element-id="e504f57e-b90a-11f9-21ce-b781b3559a95">
              <div class="w-layout-grid f-contact-form-grid-copy">
                <div><label for="Contact-First-Name-03" class="f-field-label-3-copy">使用者名稱</label><input type="text" class="f-field-input-3 w-input" maxlength="256" name="Contact-First-Name-03" data-name="Contact First Name 03" placeholder="使用者名稱 (至少 3 個字元)" id="Contact-First-Name-03"></div>
                <div><label for="Contact-Last-Name-03" class="f-field-label-3">電子郵件</label><input type="text" class="f-field-input-3 w-input" maxlength="256" name="Contact-Last-Name-03" data-name="Contact Last Name 03" placeholder="請填寫Email" id="Contact-Last-Name-03" required=""></div>
                <div><label for="Contact-Email-03" class="f-field-label-3">密碼</label><input type="email" class="f-field-input-3 w-input" maxlength="256" name="Contact-Email-03" data-name="Contact Email 03" placeholder="請設定6-15位密碼" id="Contact-Email-03" required=""></div>
                <div><label for="Contact-Phone-03" class="f-field-label-3">密碼確認</label><input type="tel" class="f-field-input-3 w-input" maxlength="256" name="Contact-Phone-03" data-name="Contact Phone 03" placeholder="請再輸入一次密碼" id="Contact-Phone-03" required=""></div>
              </div>
              <a href="#" class="button-80-copy w-button">註冊</a>
            </form>
      ...
      <section class="section-12316-copy-copy">
        <div class="w-layout-blockcontainer container-2288-copy w-container">
          <p class="paragraph-11">已經擁有5TEAM帳號嗎?</p>
          <a href="login-register/loginpage.html" class="button-79 w-button">按此登入</a>
        </div>
      </section>
    </div>
    ...
    <section class="footer-light-05185-copy-copy">
      <div class="container">
        <div class="footer-wrapper-two">
          ...
          <div class="footer-form w-form">
            <form id="wf-form-Footer-Form" name="wf-form-Footer-Form" data-name="Footer Form" method="get" class="footer-form-container" data-wf-page-id="650071e17cd3c26438525fe0" data-wf-element-id="d7c60714-2eee-98b4-1588-3891527f5329">
