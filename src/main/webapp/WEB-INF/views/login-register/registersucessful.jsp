...
<html data-wf-page="650071e17cd3c26438525fff" data-wf-site="64e5ed3359b16400aec286b0">
<head>
  <meta charset="utf-8">
...
<body>
  ...
  <div class="page-wrapper-77py">
    ...
    <div class="section no-padding-vertical">
      ...
      <div class="w-layout-blockcontainer container-30pycopy w-container">
        <h1 class="heading-29">註冊成功！歡迎加入 5TEAM</h1>
        <div class="text-block-21"><strong class="bold-text">請按下方按鈕返回首頁,五秒後將自動跳轉回首頁</strong></div>
        <a href="index.html" class="button-83 w-button">首頁</a>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="footer-wrapper-two">
        ...
        <div class="footer-form w-form">
          <form id="wf-form-Footer-Form" name="wf-form-Footer-Form" data-name="Footer Form" method="get" class="footer-form-container" data-wf-page-id="650071e17cd3c26438525fff" data-wf-element-id="f441a17e-0218-ad41-4792-bb1474696d31">
