				...
				<div class="wrapper nav-bar-wrapper">
					...
					<div class="navigation">
						<nav role="navigation" class="nav-menu w-nav-menu">
							<a href="http://10.0.101.249:8080" class="nav-link w-nav-link">首頁</a>
							...
							<div class="pricing-card-two">
								...
								<div class="pricing-content">
									<div class="pricing-info">
										<h3>
											<strong>收穫日III${cart.itemId}</strong>
										</h3>
										<h4>價格NT$ ${cart.price}</h4>
					...
					<div class="prici88opy">
						<div class="pricing-info-77">
							...
							<h3>NT$ ${totalPrice}</h3>
												...
												<select id="" class="button-90 w-button">
													<option value="" disabled selected>優惠券選擇</option>
													<option value="">中秋節優惠65折(有效期限2023-10-30)</option>
													<option value="">滿千折百(有效期限2023-10-30)</option>
													<option value="">聖誕節優惠6折(有效期限2023-10-30)</option>
													<option value="">新註冊會員優惠9折(有效期限2023-10-30)</option>
												</select>		
		...
		<div class="prici88opy">
			<div class="pricing-info-77">
				<c:forEach var="balance" items="${accountBalances}">
					<!-- 顯示點數餘額 -->
					<h3>目前點數</h3>
					<h3>${balance.currentAccountBalance}p</h3>
				</c:forEach>
			</div>
		</div>
