...
<html data-wf-page="650071e17cd3c2643852603d" data-wf-site="64e5ed3359b16400aec286b0">
<head>
  <meta charset="utf-8">
...
<body class="body-12">
          ...
          <nav role="navigation" class="nav-menu w-nav-menu">
            ...
            <div data-hover="false" data-delay="0" class="dropdown w-dropdown">
              ...
              <nav class="w-dropdown-list">
                <a href="game-search-page/view-purchase-history-copy-3.html" aria-current="page" class="dropdown-link w-dropdown-link w--current">射擊遊戲</a>
                <a href="game-search-page/view-purchase-history-copy-3.html" aria-current="page" class="dropdown-link-2 w-dropdown-link w--current">動作冒險</a>
                <a href="game-search-page/view-purchase-history-copy-3.html" aria-current="page" class="dropdown-link-3 w-dropdown-link w--current">角色扮演</a>
                <a href="game-search-page/view-purchase-history-copy-3.html" aria-current="page" class="dropdown-link-4 w-dropdown-link w--current">即時戰略</a>
                <a href="game-search-page/view-purchase-history-copy-3.html" aria-current="page" class="dropdown-link-5 w-dropdown-link w--current">卡牌策略</a>
              </nav>
            </div>
  ...
  <div class="section-c12y haze-c12y no-padding-top-c12y outer-container-c12y">
    <div class="wrapper inner-container1">
      <div class="shop-header-c12y inner-container2-c12y">
        <h3 class="no-ma15opy">角色扮演</h3>
        <div class="shop-header-line-c12y">
          <div class="shop-header-color-c12y"></div>
        </div>
      </div>
      <div class="full-width inner-container3 w-dyn-list">
        <div role="list" class="products inner-container4 w-dyn-items">
          <div data-w-id="6be50139-7c06-ee93-6d68-c7507f4c49b7" style="opacity:0" role="listitem" class="product-card-wrapper-c12y inner-container5-c12y w-dyn-item">
            <a href="#" class="product-card-c12y inner-container6-c12y w-inline-block">
              <div class="product-card-image-wrapper-c12y inner-container7-c12y"><img alt="" src="https://d3e54v103j8qbb.cloudfront.net/plugins/Basic/assets/placeholder.60f9b1840c.svg"></div>
              <h4 class="product-card-heading-c12y">楓之谷</h4>
              <div class="product-card-price-c12y">價格:100$</div>
            </a>
          </div>
        </div>
  ...
  <div class="section-c13y-copy haze-c12y-copy no-padding-top-c13y-copy outer-container-c13y-copy">
    <div class="wrapper inner-container1">
      <div class="shop-header-c12y inner-container2-c12y">
        <h3 class="no-ma15opy">角色扮演</h3>
        <div class="shop-header-line-c12y">
      ...
      <div class="full-width inner-container3 w-dyn-list">
        <div role="list" class="products inner-container4 w-dyn-items">
          <div data-w-id="482d89eb-1bf4-290a-8606-791e9f0fa278" style="opacity:0" role="listitem" class="product-card-wrapper-c12y inner-container5-c12y w-dyn-item">
            <a href="#" class="product-card-c12y inner-container6-c12y w-inline-block">
              <div class="product-card-image-wrapper-c12y inner-container7-c12y"><img alt="" src="https://d3e54v103j8qbb.cloudfront.net/plugins/Basic/assets/placeholder.60f9b1840c.svg"></div>
              <h4 class="product-card-heading-c12y">楓之谷</h4>
              <div class="product-card-price-c12y">價格:100$</div>
  ...
  <section class="foote189r-light-c777op">
    <div class="container">
      <div class="footer-wrapper-two">
        ...
        <div class="footer-form w-form">
          <form id="wf-form-Footer-Form" name="wf-form-Footer-Form" data-name="Footer Form" method="get" class="footer-form-container" data-wf-page-id="650071e17cd3c2643852603d" data-wf-element-id="fb55b050-0e83-8729-77e7-1b019a86784f">
    ...
    <div class="footer-bottom-2">
      ...
      <a href="#" class="footer-social-link-2 w-inline-block"><img src="images/face-removebg-preview.png" loading="lazy" width="96" alt="" class="image-38"></a>
      <a href="#" class="footer-social-link-2 w-inline-block"><img src="images/Twi-removebg-preview.png" loading="lazy" width="97" alt="" class="image-37"></a>
      <div class="footer-social-block-two">
        <a href="#" class="footer-social-link-2 w-inline-block"><img src="images/YT-removebg-preview.png" loading="lazy" width="93" alt="" class="image-39"></a>
      </div>
    </div>
  </section>
